...
<div class="row">
	<div class="col-12">
		<div class="btn-group group-buttons">
			...
			<a class="btn btn-warning btn-xs" href="{{ action('PurchaseReturnController@edit', $purchase_return->id) }}"><i class="fas fa-edit"></i> {{ _lang('Edit') }}</a>
		</div>
		...
		<div class="card clearfix">
			...
			<span class="panel-title d-none">{{ _lang('Purchase Retrurn') }}</span>
								...
								<td colspan="2" class="pt-5">
									<div class="row">
										...
										<div class="invoice-col-6">
											 <h5 class="mb-1"><b>{{ _lang('Supplier Details') }}</b></h5>
										...
										<div class="invoice-col-6">
											<div class="d-inline-block float-md-right">
												...
												<h5 class="mb-1"><b>{{ _lang('Purchase Return') }}</b></h5>
												<b>{{ _lang('Return ID') }} #:</b> {{ $purchase_return->id }}<br>
												<b>{{ _lang('Return Date') }}:</b> {{ date($date_format, strtotime($purchase_return->return_date)) }}<br>
